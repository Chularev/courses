...
int main(int argc, char **argv) {
  ...
  std::string input_file = "/mnt/heap/qt_project/study_cv/cuda/labs/lab_2/cinque_terre_small.jpg";
  std::string output_file= "/mnt/heap/qt_project/study_cv/cuda/labs/lab_2/cinque_terre_small_result.jpg";;
  std::string reference_file = "/mnt/heap/qt_project/study_cv/cuda/labs/lab_2/cinque_terre_gold.jpg";;
